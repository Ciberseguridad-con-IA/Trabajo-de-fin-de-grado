...
#Se limpia la respuesta del modelo
...
!pip install --quiet langchain_community langchain_deepseek
...
# Prompt en español porque textos en español, se le indica que responda en ingles

def generate_qa_structure(topic: str) -> dict:
    ...
    try:
        ...
        embedded_json_match = re.search(r"\{.*\}", text_output, re.DOTALL)  # Corregido: usa text_output en vez de raw_content
