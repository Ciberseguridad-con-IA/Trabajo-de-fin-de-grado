# -*- coding: utf-8 -*-
"""DSR1+V3-RAG-Answer.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1RVFeG01CjJ75nvj8T5NO0vflo7vXmGrW
"""
...
import os
print(os.path.exists('/content/drive/MyDrive/TFG-Ciber/Data-Set-Nacho/cybernetic-hue-455208-i2-d9a46af731a9.json'))
...
You are a highly skilled cybersecurity teacher with deep expertise in ethical hacking and penetration testing.
...
If the information provided is insufficient to answer accurately, respond with: "I don't have enough information to answer that."
...
def generate(state: State):
    ...
    response_r = llm_r.invoke(messages)
    response_c = llm_c.invoke(messages)
    result = "[Answer]: " + response_c.content + "\n\n"
    result += "[Explanation]: " + response_r.additional_kwargs["reasoning_content"]
...
response = graph.invoke({"question": questions_list[0]})
